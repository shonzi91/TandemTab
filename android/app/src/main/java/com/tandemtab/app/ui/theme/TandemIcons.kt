...
object TandemIcons {
    ...
    // Same path as the web's `i-share` symbol in IconSprite.razor — an out-tray with an arrow leaving it. Copied
    // rather than approximated so "export" draws identically on both surfaces.
    val Share = icon("M12 15V3M8 7l4-4 4 4M5 13v6a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6")
