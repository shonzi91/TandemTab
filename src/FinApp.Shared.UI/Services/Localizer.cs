...
public sealed class Localizer(IJSRuntime js)
{
    ...
    private static readonly Dictionary<string, string> Bg = new(StringComparer.Ordinal)
    {
        ...
        ["Round-ups would have set aside {0} (to the nearest 1) or {1} (to the nearest 5) here — switch them on in Edit account"] = "Закръгленията щяха да заделят {0} (до най-близкото 1) или {1} (до най-близкото 5) тук — включи ги в Редакция на профила",
