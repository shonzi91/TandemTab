...
public sealed class Localizer(IJSRuntime js)
{
    ...
    private static readonly Dictionary<string, string> Bg = new(StringComparer.Ordinal)
    {
        ...
        ["Overview"] = "Преглед",
        ["Home"] = "Начало",
        // O9 renamed the tab's label. "Home" stays in the table — Android and older strings still use it.
        ["Dashboard"] = "Табло",
        ["Open the app on"] = "Отваряй приложението на",
        // O5 — the recurring list's two sections.
        ["Coming up"] = "Предстоящи",
        ["Already this period"] = "Вече през този период",
        // O10 — the confirmations that were missing. Each says what is lost, so each needs its own wording.
        ["Remove this label?"] = "Да се премахне ли този етикет?",
        ["“{0}” comes off every expense that carries it. The expenses themselves are untouched."] = "„{0}“ отпада от всеки разход, който го носи. Самите разходи остават непроменени.",
        ["Remove this recurring item?"] = "Да се премахне ли този повтарящ се запис?",
        ["It stops reminding you. Anything already logged from it stays where it is."] = "Спира да ви напомня. Вече записаното от него остава непроменено.",
        ["Remove this cost?"] = "Да се премахне ли този разход?",
        ["It comes off the fund's plan straight away."] = "Отпада от плана на фонда веднага.",
        ["Unsettle this expense?"] = "Да се отмени ли разпределението?",
        ["The expense on the other account is removed and this one goes back to its full amount."] = "Разходът в другата сметка се премахва, а този се връща към пълната си сума.",
        ["Disconnect your bank?"] = "Да се прекъсне ли връзката с банката?",
        ["New transactions stop arriving, and anything still waiting to be reviewed is discarded. Your logged expenses are untouched. You can reconnect later — you'll be asked to consent again."] = "Новите трансакции спират да пристигат, а чакащите за преглед се отхвърлят. Записаните разходи остават непроменени. Можете да свържете отново по-късно — ще бъдете попитани за съгласие пак.",
        ["Not an expense?"] = "Не е разход?",
        ["“{0}” is dropped from the review and won't come back on the next sync."] = "„{0}“ отпада от прегледа и няма да се появи при следващата синхронизация.",
        ["Forget this rule?"] = "Да се забрави ли това правило?",
        ["Transactions from this merchant go back to being reviewed by hand. Expenses already filed by the rule stay as they are."] = "Трансакциите от този търговец се връщат към ръчен преглед. Вече заведените по правилото разходи остават непроменени.",
        ["“{0}” goes back to being reviewed by hand. Expenses already filed by the rule stay as they are."] = "„{0}“ се връща към ръчен преглед. Вече заведените по правилото разходи остават непроменени.",
        ["Forget"] = "Забрави",
        ["Remove your picture?"] = "Да се премахне ли снимката ви?",
        ["Takes effect the next time you open the app."] = "Влиза в сила при следващото отваряне на приложението.",
        ["Spending"] = "Разходи",
        ["Goals"] = "Цели",
        ["Wallets"] = "Портфейли",
        ["Setup"] = "Настройки",
        ...
        ["Where the money that came in went"] = "Къде отидоха парите, които влязоха",
        ...
        ["Set aside {0} via round-ups in this window"] = "Заделени {0} чрез закръгляния в този период",
        ["Round-ups would have set aside {0} (to the nearest 1) or {1} (to the nearest 5) this period — switch them on in Edit account"] = "Закръгленията щяха да заделят {0} (до най-близкото 1) или {1} (до най-близкото 5) този период — включи ги в Редакция на профила",
        ["Round-ups would have set aside {0} (to the nearest 1) or {1} (to the nearest 5) this week — switch them on in Edit account"] = "Закръгленията щяха да заделят {0} (до най-близкото 1) или {1} (до най-близкото 5) тази седмица — включи ги в Редакция на профила",
        ["{0} via round-ups"] = "{0} чрез закръгляния",
        ["See what round-ups could set aside — with Pro"] = "Виж колко биха заделили закръгленията — с Pro",
        ...
        ["You and {0} got here together."] = "Ти и {0} стигнахте дотук заедно.",
        ["Nice!"] = "Супер!",
        ["{0} and {1}"] = "{0} и {1}",
        ["and {0}"] = "и {0}",
        // F4 — round-ups into a savings bucket
        ["Round up spending"] = "Закръгляй разходите",
        ["Off"] = "Изкл.",
        ["Into"] = "В",
        ["Create a savings bucket first — round-ups need somewhere to go."] = "Първо създай спестовна кошница — закръгленията трябва да отиват някъде.",
        ["Every expense rounds up to the next {0}, and the difference is set aside. A {1} coffee saves {2}."] = "Всеки разход се закръгля нагоре до {0}, а разликата се заделя. Кафе за {1} спестява {2}.",
        ["Off. Turn this on to round each expense up and quietly save the change."] = "Изключено. Включи го, за да закръгляш всеки разход и тихо да спестяваш рестото.",
        ["{0} saved this way so far."] = "{0} спестени по този начин досега.",
        ["Round-up"] = "Закръгляне",
        // F2 — tag → category binding
        ["Edit tag"] = "Редакция на етикет",
        ["Files into"] = "Отива в",
        ["— no category —"] = "— без категория —",
        ["Picking this tag on a new expense will select that category for you. Expenses you already logged keep the category they have."] = "Избирането на този етикет при нов разход ще избере тази категория вместо теб. Вече записаните разходи запазват категорията си.",
        ["Filed under {0} — change it above if that's not right."] = "Записано в {0} — смени го отгоре, ако не е вярно.",
        ...
        ["ahead"] = "напред",
        ["{0} paid ahead"] = "{0} платени предсрочно",
        ["Against this loan’s original schedule — money already paid ahead, not a projection."] = "Спрямо първоначалния план на този заем — вече платени пари, не прогноза.",
        ...
        ["How you'll state the balance"] = "Как ще посочите остатъка",
        ...
        ["How much of it comes off that expense"] = "Колко от тях се приспадат от разхода",
        ["{0} comes off that expense; {1} is logged as income."] = "{0} се приспадат от разхода; {1} се записват като доход.",
        ["All {0} comes off that expense — nothing is logged as income."] = "Всичките {0} се приспадат от разхода — нищо не се записва като доход.",
        ...
        ["Search expenses…"] = "Търси разходи…",
        ["Nothing matches that search."] = "Нищо не съвпада с търсенето.",
        ["Kept"] = "Задържано",
        ...
        ["Against the original schedule — money already paid ahead, not a projection."] =
            "Спрямо първоначалния график — вече платени пари напред, не прогноза.",
        ...
        ["Pay {0} a month instead"] = "Плащай по {0} на месец",
        ["We'll drop the installment here. Your lender has to agree to it too — this doesn't tell them."] =
            "Ще намалим вноската тук. Кредиторът също трябва да се съгласи — това не го уведомява.",
