...
- **⚠️ Carry-over / next (the door is close):**
  - **The verification hour** (OPEN-BETA) is the remaining readiness work, none of it started this session: (1) eyeball the **S80 "Saved toward goals" slice** with a real disbursement; (2) **period lifecycle** end-to-end (start next / close / remove latest / switch accounts); (3) a **fresh-account stranger walkthrough**.
