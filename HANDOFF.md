...
Last updated: 2026-07-31 (Session 74 — **web-only: rebuilt the Home money-summary hero (Safe to spend · Saved · Spent · Money in), added a "money in" savings-rate denominator (domain), a Home "where your money went" mini-donut, empty-fund collapse in Wallets, Total-saved Goals header + debt APR, and Spending/Breakdown row reworks; deployed `finapp-00259-f8r`; committed + pushed to `main`**). Read this + [README.md](README.md) + [TRANSFER.md](TRANSFER.md) + [docs/MOBILE.md](docs/MOBILE.md) + [docs/DOMAIN-REMOVAL.md](docs/DOMAIN-REMOVAL.md) + [android/README.md](android/README.md) + recent `git log` to catch up.
