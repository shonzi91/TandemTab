...
Last updated: 2026-07-26 (Session 56). Read this + [README.md](README.md) + [TRANSFER.md](TRANSFER.md) + [docs/MOBILE.md](docs/MOBILE.md) + [docs/DOMAIN-REMOVAL.md](docs/DOMAIN-REMOVAL.md) + [android/README.md](android/README.md) + recent `git log` to catch up.
...
- **Verify recipe still works great** (register on local `finapp-server` :5179, drive via `computer`/`javascript_tool`, `history.back()` to exercise Back). Screenshots worked this session (didn't time out).
