...
Last updated: 2026-07-29 (Session 71 — **native Android: Runway "Details" screen, split Profile/Account sheets, edit-last, budget gradient, manual dark-theme toggle (defaults dark), per-row expense edit buttons**; emulator-verified, committed to `main`). Read this + [README.md](README.md) + [TRANSFER.md](TRANSFER.md) + [docs/MOBILE.md](docs/MOBILE.md) + [docs/DOMAIN-REMOVAL.md](docs/DOMAIN-REMOVAL.md) + [android/README.md](android/README.md) + recent `git log` to catch up.
